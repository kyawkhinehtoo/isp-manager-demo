            ...
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                  ...
                  <div class="col-span-1 sm:col-span-1">
                    ...
                    <div class="mt-1 flex rounded-md shadow-sm">
                      ...
                      <input type="number" v-model="form.phone_2" name="phone_2" id="phone_2"
                        class="pl-10 focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-md sm:text-sm border-gray-300"
                        placeholder="e.g 0945000111" v-on:keypress="isNumber(event)" :disabled="checkPerm('phone_2')" />
                    </div>
                  ...
                  <div class="col-span-1 sm:col-span-1">
                    ...
                    <div class="mt-1 flex rounded-md " v-if="projects.length !== 0">
                      <multiselect deselect-label="Selected already" :options="projects" track-by="id" label="name"
                        ...
                        :disabled="checkPerm('project_id')" :onchange="goID" @select="goID" @close="goID"></multiselect>
                    </div>
                  ...
                  <div class="col-span-1 sm:col-span-1">
                    ...
                    <div class="mt-1 flex rounded-md shadow-sm" v-if="pops.length !== 0">
                      <multiselect deselect-label="Selected already" :options="pops" track-by="id" label="site_name"
                        v-model="form.pop_id" :allow-empty="true" :disabled="checkPerm('sn_id')" @select="POPSelect">
                      </multiselect>
                    </div>
                  </div>
                  <div class="col-span-1 sm:col-span-1">
              ...
              <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                <inertia-link :href="route('customer.index')"
                  class="inline-flex justify-center py-2 px-4 border border-transparent  text-sm font-medium rounded-md text-white bg-yellow-600 hover:bg-yellow-700 shadow-sm focus:outline-none focus:border-blue-300 focus:shadow-outline-blue transition ease-in-out duration-150">Back</inertia-link>
...
export default {
  ...
  setup(props) {
    ...
    return { form, submit, resetForm, isNumber, checkPerm, res_sn, res_dn, DNSelect, goID, fillPppoe, pppoe_auto, generatePassword, POPSelect, res_packages, isEmptyObject };
  },
};
</script>
<style>
