      ...
      <div class="mx-auto sm:px-6 lg:px-8">
        ...
        <div class="py-2 md:inline-flex justify-between w-full gap-4">
          ...
          <div class="flex w-full self-center">
            <litepie-datepicker placeholder="Ticket Date" :formatter="formatter" separator=" to " v-model="incidentDate"
              tabindex="6"></litepie-datepicker>
            ...
            <div class="">
              ...
              <div class="py-2 divide-y divide-yellow-500">
                <div class="mt-1 px-3 flex w-full justify-between">
                  ...
                  <div class="flex">
                    <span
                      class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white bg-white rounded-l-md text-sm shadow outline-none focus:outline-none">
                      Ticket ID </span>
                    <input type="text" v-model="form.code" name="code" id="code"
                      class="mr-2 border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white bg-white rounded-r-md text-sm shadow outline-none focus:outline-none"
                      disabled />
              ...
              <div class="bg-white rounded-t-lg w-full mx-auto mt-1 shadow-xl divide-y divide-gray-200">
                      ...
                      <div class="py-2 col-span-4 sm:col-span-4" v-if="form.type == 'suspension'">
                        <div class="grid grid-cols-2 gap-2">
                          <div class="col-span-1 sm:col-span-1">
                            <div class="mt-1 flex rounded-md shadow-sm">
                              <span
                                class="-mt-1 z-10 leading-snug font-normal absolute text-center text-blueGray-300 absolute bg-transparent rounded text-base items-center justify-center w-8 pl-3 py-3">
                ...
                $page.props.errors.end_date }}</p>
                      ...
                      <div class="py-2 col-span-4 sm:col-span-4" v-if="form.type == 'resume'">
                        <div class="mt-1 flex rounded-md shadow-sm">
                          <span
                            class="z-10 -mt-1 leading-snug font-normal absolute text-center text-blueGray-300 absolute bg-transparent rounded text-base items-center justify-center w-8 pl-3 py-3">
                            <i class="fas fa-play"></i>
                          </span>
                          <input type="date" v-model="form.start_date" name="start_date" id="start_date"
                            class="pl-10 form-input focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-md sm:text-sm border-gray-300" />
...
export default {
  ...
  setup(props) {
    ...
    const showPriority = (data) => {
      let url = "/incident";
      if (data != 'all') {
        Inertia.get(url, { priority: data }, { preserveState: true });
      } else {
